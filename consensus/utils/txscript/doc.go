...
karlsen transaction scripts.

# Script Overview

Karlsen transaction scripts are written in a stack-base, FORTH-like language.

The karlsen script language consists of a number of opcodes which fall into
...
Typical karlsen scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend karlsen.
